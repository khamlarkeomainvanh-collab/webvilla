...
urlpatterns = [
    ...
    path('custom-order-request', views.custom_order_request_view, name='custom-order-request'),
    path('remove-custom-cart-item/<str:custom_id>', views.remove_custom_cart_item_view, name='remove-custom-cart-item'),
    path('add-qty-custom/<str:custom_id>', views.add_qty_custom_view, name='add-qty-custom'),
    path('remove-qty-custom/<str:custom_id>', views.remove_qty_custom_view, name='remove-qty-custom'),
    path('admin-custom-orders', views.admin_custom_orders_view, name='admin-custom-orders'),
    path('delete-custom-order/<int:pk>', views.delete_custom_order_view, name='delete-custom-order'),
    path('done-custom-order/<int:pk>', views.done_custom_order_view, name='done-custom-order'),
    ...
    path('fulfill-advance-booking/<str:order_group>', views.fulfill_advance_booking_view, name='fulfill-advance-booking'),
    ...
    path('edit-walkin-sale/<int:pk>', views.edit_walkin_sale_view, name='edit-walkin-sale'),
